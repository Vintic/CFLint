...
public class Test_file {
    ...
    public void setUp() throws IOException, CFLintConfigurationException {
        ...
        //String bugs_string = "AVOID_USING_ABORT,AVOID_USING_CFABORT_TAG,AVOID_USING_WRITEDUMP,AVOID_USING_CFDUMP_TAG,MISSING_VAR,ARGUMENT_INVALID_NAME,COMPONENT_INVALID_NAME,VAR_INVALID_NAME,METHOD_INVALID_NAME,EXPLICIT_BOOLEAN_CHECK,AVOID_USING_ISDATE,SQL_SELECT_STAR,AVOID_USING_USE_IN_QUERY,USE_TIMEOUT_WITH_MULTIPLIER,AVOID_USING_NOLOCK,USE_MTEAM_DATA_FORMAT,AVOID_SESSION_IN_JOB,SQL_IMPLICIT_IDENTITY,SQL_VARCHAR_DIMENSION,DATASOURCE_ON_DBTYPE_QUERY,NOT_VALID_CFQUERYPARAM,LOOP_ITEM_SPACE,AVOID_SPACE_IN_TAG,AVOID_UNNAMED_CONSTRAINT_IN_QUERY,AVOID_CONSTANT_DATASOURCE,SQL_DEPRECATED_CODE,ARG_TYPE_MISSING,ARG_VAR_MIXED,ARGUMENT_MISSING_NAME,ARG_VAR_CONFLICT,UNUSED_LOCAL_VARIABLE,NO_DEFAULT_INSIDE_SWITCH,AVOID_USING_CFEXECUTE_TAG,AVOID_USING_CFINSERT_TAG,AVOID_USING_CFMODULE_TAG,AVOID_USING_CFUPDATE_TAG,AVOID_QUERY_IN_LOOP,AVOID_SPACE_IN_HTML_ID,MISSING_ORDER_BY_IN_QUERY,USE_TIMEOUT,AVOID_ROUND_IN_QUERY";
        String bugs_string = "MISSING_ORDER_BY_IN_QUERY";
        String[] bugs = bugs_string.split(",");
    ...
    public void badFileCFML() throws CFLintScanException, IOException, CFLintConfigurationException {
        String cfcSrc = "E:\\PUB33\\autotest\\cflint_final\\src\\test\\java\\com\\cflint\\test.cfm";
        /*List<String> file = new ArrayList<>();
        file.add(cfcSrc);
        File file1 = new File(cfcSrc);*/
        String contents = new String(Files.readAllBytes(Paths.get(cfcSrc)));
        CFLintResult lintresult = cfBugs.scan(contents, "ebay_commissions.cfm");
